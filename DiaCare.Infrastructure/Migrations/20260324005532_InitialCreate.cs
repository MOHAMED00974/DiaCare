        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FastingGlucoseLevel = table.Column<int>(type: "int", nullable: false),
                    InsulinLevel = table.Column<double>(type: "float", nullable: false),
                    HbA1cLevel = table.Column<double>(type: "float", nullable: false),
                    CholesterolLevel = table.Column<int>(type: "int", nullable: false),
                    ...
                    DailyCalorieIntake = table.Column<int>(type: "int", nullable: false),
                    SugarIntakeGramsPerDay = table.Column<double>(type: "float", nullable: false),
                    FamilyHistoryDiabetes = table.Column<int>(type: "int", nullable: false),
                    WaistCircumferenceCm = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PredictionResults_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PredictionResults_HealthProfiles_HealthProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PredictionResults_HealthProfileId",
